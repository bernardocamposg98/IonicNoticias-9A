...
export class NoticiasService {
  ...
  getNoticias() {
    return this.http.get<RespuestaNoticias>(`https://newsapi.org/v2/everything?q=bitcoin&from=2019-05-18&sortBy=publishedAt&apiKey=526eaee3668b49c39cd7e51a4f5244c3
    `);
  }
}
